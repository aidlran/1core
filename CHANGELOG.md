...
## [Note 0.2.0](https://github.com/1coreio/1core/releases/tag/note-v0.2.0) - 2025-12-30

- Added error handling and reprompt when incorrect passphrase is entered.

## [Vault 3.1.0](https://github.com/1coreio/1core/releases/tag/pass-v3.1.0) - 2025-12-30

- Added error handling and reprompt when incorrect passphrase is entered.

## [Note 0.1.0](https://github.com/1coreio/1core/releases/tag/note-v0.1.0) - 2025-10-14

- Initial version.
- Added `append`, `cat`, `delete`, `edit`, `list`, `migrate`, `rename` & `set` commands.
- Added AGPL-3.0 license.

## [Vault 3.0.0](https://github.com/1coreio/1core/releases/tag/pass-v3.0.0) - 2025-10-14
...
## [Vault 2.1.0](https://github.com/1coreio/1core/releases/tag/pass-v2.1.0) - 2025-07-17

- Added `note` subcommand.

## [Vault 2.0.0-rc.8](https://github.com/1coreio/1core/releases/tag/pass-v2.0.0-rc.7) - 2025-06-25

- Added missing peer dependencies.

## [Vault 2.0.0-rc.7](https://github.com/1coreio/1core/releases/tag/pass-v2.0.0-rc.7) - 2025-06-24
...
## [Vault 2.0.0-rc.6](https://github.com/1coreio/1core/releases/tag/pass-v2.0.0-rc.6) - 2025-04-13
